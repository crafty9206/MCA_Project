...
export function CareChecklist({ tasks, history, onToggle, onCreated, onUpdated, onDeleted }: CareChecklistProps) {
  ...
  return (
    <section className="panel checklist-panel">
      ...
      <button className="text-button" type="button" onClick={() => setShowForm((visible) => !visible)}>{showForm ? 'Close custom task' : 'Add a custom task'} <span>{showForm ? '↑' : '→'}</span></button>
