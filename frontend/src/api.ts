...
export type CareTask = { id: string; taskDetailId: string; title: string; taskDate: string; completed: boolean }
export type DailyWellbeing = { date: string; waterGlasses: number; waterGoal: number; prenatalVitaminTaken: boolean; activityMinutes: number; activityGoal: number }
